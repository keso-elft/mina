...
/**
 * 下端监测设备校零校满
 * <--- QN=20040516010101001;ST=32;CN=3011;PW=123456;MN=88888880000001;Flag=3;CP=&&PollD=101&&
 ...
 *
 */
public class Handler3011 implements MinaHandler{

	protected Logger log = LoggerFactory.getLogger(Handler3011.class);
	...
	private boolean setPollD(String pollId) {
		// TODO Auto-generated method stub
		return true;
	}
	
	public static void main(String[] args) {
		Handler3011 handler = new Handler3011();
