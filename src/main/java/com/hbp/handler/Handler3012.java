...
/**
 * 下端检测设备即时采样
 * <--- QN=20040516010101001;ST=32;CN=3012;PW=123456;MN=88888880000001;Flag=3;CP=&&PollD=101&&
 ...
 *
 */
public class Handler3012 implements MinaHandler {
	...
	private boolean setPolld(String polld) {
		// TODO Auto-generated method stub
		return true;
	}
	
	public static void main(String[] args) {
		Handler3012 handler = new Handler3012();
